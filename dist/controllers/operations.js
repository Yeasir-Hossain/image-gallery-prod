...
exports.updateMany = exports.update = exports.sort = exports.save = exports.removeAll = exports.remove = exports.populate = exports.findOne = exports.find = exports.create = exports.bulkCreate = exports.aggr = void 0;
...
const find = ({
  ...
  key.options = noPaginate ? {
    sort: {}
  } : _objectSpread(_objectSpread({}, key.populate && {
  ...
  // May break
  resolve(table[method](...args)[noPaginate ? 'populate' : 'then'](populate)).then(res => resolve(res)).catch(e => reject(e));
});
